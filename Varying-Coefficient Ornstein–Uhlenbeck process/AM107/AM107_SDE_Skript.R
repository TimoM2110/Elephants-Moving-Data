...
track <- subset(data, ID == unique(ID)[2]) # keep AM107 only
...
keep_rows <- which(track$date > as.POSIXct("2009-06-11 00:00:00") &
                     track$date < as.POSIXct("2009-08-12 23:59:59"))
...
keep_rows_2 <- which(track$date > as.POSIXct("2007-10-01 00:00:00") &
                       track$date < as.POSIXct("2008-03-30 23:59:59"))
