...
track <- subset(
  data,
  ID == unique(ID)[6] # keep AM253 only
) 
...
keep_rows <- which(
  track$date > as.POSIXct("2008-06-15 00:00:00") &
    track$date < as.POSIXct("2008-08-15 23:59:59")
)
...
keep_rows_2 <- which(
  track$date > as.POSIXct("2007-10-01 00:00:00") &
    track$date < as.POSIXct("2008-04-15 23:59:59")
)
