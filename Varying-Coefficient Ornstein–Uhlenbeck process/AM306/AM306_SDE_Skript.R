...
track <- subset(data, ID == unique(ID)[9]) # keep AM306 only
...
keep_rows <- which(track$date > as.POSIXct("2008-05-30 00:00:00") &
                     track$date < as.POSIXct("2008-09-01 23:59:59"))
...
keep_rows_2 <- which(track$date > as.POSIXct("2008-10-01 00:00:00") &
                       track$date < as.POSIXct("2009-02-11 23:59:59"))
